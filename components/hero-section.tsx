...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[oklch(0.92_0.08_290)] via-[oklch(0.90_0.10_330)] to-[oklch(0.88_0.08_30)] py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-balance mb-6 bg-gradient-to-r from-[oklch(0.55_0.20_290)] to-[oklch(0.60_0.18_330)] bg-clip-text text-transparent">
          Hacktoberfest Mini Hackathon 2025
        </h1>

        <p className="text-2xl sm:text-3xl font-semibold mb-4 text-[oklch(0.45_0.15_300)]">
          A one-day celebration of open source, creativity, and kindness 💕
        </p>

        <p className="text-lg sm:text-xl text-[oklch(0.40_0.10_290)] max-w-3xl mx-auto mb-12 leading-relaxed">
          Join us for 24 hours of learning, coding, and collaboration! Whether it's your first PR or your 100th, this
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12 max-w-4xl mx-auto">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-2 border-[oklch(0.85_0.08_290)]">
            ...
            <div className="text-base font-bold text-[oklch(0.35_0.10_290)]">October 25, 2025</div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-2 border-[oklch(0.82_0.12_30)]">
            ...
            <div className="text-base font-bold text-[oklch(0.35_0.10_30)]">9:00 AM – 9:00 PM</div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-2 border-[oklch(0.85_0.10_180)]">
            ...
            <div className="text-base font-bold text-[oklch(0.35_0.10_180)]">Online (Worldwide!)</div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-2 border-[oklch(0.88_0.08_330)]">
            ...
            <div className="text-base font-bold text-[oklch(0.35_0.10_330)]">Code with Kindness</div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button
            size="lg"
            className="text-lg px-8 py-6 rounded-full bg-gradient-to-r from-[oklch(0.70_0.18_290)] to-[oklch(0.75_0.15_310)] hover:from-[oklch(0.65_0.20_290)] hover:to-[oklch(0.70_0.17_310)] text-white shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
          >
            Join the Hackathon 💖
          </Button>
          <Button
